    ...
    <ScreenWrapper
      ...
      headerUnScrollable={() => (
        <Header
          source={logo}
          icon1={
            <AntDesign name="search1" size={width(6)} color={AppColors.black} />
          }
          icon2={
            <AntDesign name="bells" size={width(6)} color={AppColors.black} />
          }
          firstIcon={
            <Ionicons name="filter" size={width(6)} color={AppColors.black} />
          }
        />
      )}>
