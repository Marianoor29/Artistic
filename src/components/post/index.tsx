 ...
 Price
  ...
  return (
    <View style={[styles.container, container]}>
      ...
      <MaterialCommunityIcons name='settings-helper' size={width(6)} color={AppColors.black}/>
      </View>
      </View>
    ...
    <MaterialCommunityIcons name='bookmark-outline' size={width(6)} color={AppColors.black}/>
