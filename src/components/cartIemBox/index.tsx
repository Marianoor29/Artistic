...
const CartItemBox = ({
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.artistName} numberOfLines={1}>{itemName}</Text>
            <Text style={styles.price} numberOfLines={1}>{price}</Text>
              <Button buttonStyle={styles.btnStyle} text={'Remove'} textStyle={styles.btnTextStyle}/>
            </View >
            <View style={styles.rightContainer}>
                <View style={styles.iconView}>
                    <AntDesign name='plus' size={width(4)} color={AppColors.blue}/>
                </View>
                <Text style={styles.price} numberOfLines={1}>{counter}</Text>
                <View style={styles.iconView}>
